...
| `0x200f192a14c85d09943f76ae3def3ffe596d93594b6d8ab55b99cdf612b4c312` | **bMOLI/ETH pool — Uniswap v4, fee 0.25%** | Created 24 Sep 2026 04:10 UTC, tx `0xb87eb11e…5f67` (412,741 gas, 0.00088 ETH). Initial price **1 ETH = 333,322 bMOLI = $0.00805/MOLI**. Position ticks 120250-127150; current tick 127175 is ABOVE it, so the position is **ALL bMOLI, zero ETH — asks only, no bid**. Indexed by GeckoTerminal as "bMOLI / ETH 0.25%"; price reads null until a trade. |
